...
def main() -> None:
    ap = argparse.ArgumentParser(description="biolord dataset entry: adamson")
    ...
    run_biolord_eval("adamson", base_seed=seed, export_notebook_pkl=export_notebook_pkl, raw_result_root=raw_result_root)
