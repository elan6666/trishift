...
def main() -> None:
    ap = argparse.ArgumentParser(description="biolord dataset entry: replogle_k562_essential")
    ...
    run_biolord_eval("replogle_k562_essential", base_seed=seed, export_notebook_pkl=export_notebook_pkl, raw_result_root=raw_result_root)
