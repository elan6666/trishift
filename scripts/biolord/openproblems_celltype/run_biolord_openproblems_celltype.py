...
def main() -> None:
    ap = argparse.ArgumentParser(description="biolord dataset entry: openproblems_celltype")
    ...
    print("[biolord-entry] launching dataset=openproblems_celltype", flush=True)
    run_biolord_eval(
