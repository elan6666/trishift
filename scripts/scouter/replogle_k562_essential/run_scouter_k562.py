...
def main() -> None:
    ap = argparse.ArgumentParser(description="Scouter dataset entry: replogle_k562_essential")
    ...
    run_scouter_eval('replogle_k562_essential', n_ensemble=n_ensemble, base_seed=seed, export_notebook_pkl=export_notebook_pkl)
