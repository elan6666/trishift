...
def main() -> None:
    ap = argparse.ArgumentParser(description="Scouter dataset entry: dixit")
    ...
    run_scouter_eval('dixit', n_ensemble=n_ensemble, base_seed=seed, export_notebook_pkl=export_notebook_pkl)
