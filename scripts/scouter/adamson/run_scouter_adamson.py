...
def main() -> None:
    ap = argparse.ArgumentParser(description="Scouter dataset entry: adamson")
    ...
    run_scouter_eval('adamson', n_ensemble=n_ensemble, base_seed=seed, export_notebook_pkl=export_notebook_pkl)
