...
def main() -> None:
    ap = argparse.ArgumentParser(description="scGPT dataset entry: scgen_pbmc_celltype")
    ap.add_argument("--seed", type=int, default=24)
    ap.add_argument("--control_pool_size", type=int, default=0)
    ...
    run_scgpt_eval(
        ...
        control_pool_size=(
            int(task.get("control_pool_size", 0))
            if int(args.control_pool_size) == 0
