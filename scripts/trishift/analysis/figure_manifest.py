...
FIGURE_ROWS: list[dict[str, Any]] = [
    ...
    {"figure": "Fig2", "panel": "h", "description": "CellOT aligned OT baseline summary across Adamson, Dixit, Norman and PBMC", "source": "artifacts/results/cellot/*/metrics_unseen_ctrl.csv", "notebook": "notebooks/Fig2_ReferenceTransfer.ipynb"},
    {"figure": "Fig3", "panel": "a", "description": "four-dataset reference construction ablation: random/kNN/OT", "source": "artifacts/results/ablation/*/*/metrics_unseen_ctrl.csv plus PBMC metrics.csv", "notebook": "notebooks/Fig3_Ablation.ipynb"},
    {"figure": "Fig3", "panel": "b", "description": "four-dataset conditioning input ablation: no reference/no prior/full", "source": "artifacts/results/ablation/*/*/metrics_unseen_ctrl.csv plus PBMC metrics.csv", "notebook": "notebooks/Fig3_Ablation.ipynb"},
    {"figure": "Fig3", "panel": "c", "description": "four-dataset shift/fusion ablation: MLP/transformer/full", "source": "artifacts/results/ablation/*/*/metrics_unseen_ctrl.csv plus PBMC metrics.csv", "notebook": "notebooks/Fig3_Ablation.ipynb"},
    {"figure": "Fig3", "panel": "d", "description": "four-dataset expression objective ablation: L_mse/L_gears/L_gears+L_neg", "source": "artifacts/results/ablation/*/*/metrics_unseen_ctrl.csv plus PBMC metrics.csv", "notebook": "notebooks/Fig3_Ablation.ipynb"},
    ...
    {"figure": "Fig4", "panel": "b", "description": "Norman held-out-control seen0 core metrics", "source": "held-out-control metrics_long", "notebook": "notebooks/Fig4_NormanGeneralization.ipynb"},
    ...
    {"figure": "Fig4", "panel": "d", "description": "Norman held-out-control response-direction agreement", "source": "artifacts/analysis/deg_prediction/*/deg_prediction_long.csv", "notebook": "notebooks/Fig4_NormanGeneralization.ipynb"},
    ...
    {"figure": "Fig5", "panel": "d", "description": "DEG-level variance recovery over strongly responsive genes", "source": "distribution_metrics_long", "notebook": "notebooks/Fig5_DistributionRecovery.ipynb"},
    ...
    {"figure": "FigS3", "panel": "a-d", "description": "held-out-control benchmark backup and aligned CellOT status", "source": "held-out-control benchmark long tables", "notebook": "notebooks/FigS3_UnseenBenchmarkBackup.ipynb"},
    {"figure": "FigS4", "panel": "a-f", "description": "ablation extensions and full Systema diagnostics", "source": "ablation metrics and systema long tables", "notebook": "notebooks/FigS4_AblationAndSystemaDiagnostics.ipynb"},
