...
FIGURE_ROWS: list[dict[str, Any]] = [
    ...
    {"figure": "Fig3", "panel": "a", "description": "reference construction ablation: Pearson for kNN/OT", "source": "artifacts/results/ablation/*/*/metrics_unseen_ctrl.csv plus PBMC metrics.csv", "notebook": "notebooks/Fig3_Ablation.ipynb"},
    {"figure": "Fig3", "panel": "b", "description": "reference construction ablation: nMSE for kNN/OT", "source": "artifacts/results/ablation/*/*/metrics_unseen_ctrl.csv plus PBMC metrics.csv", "notebook": "notebooks/Fig3_Ablation.ipynb"},
    {"figure": "Fig3", "panel": "c", "description": "reference construction ablation: Systema Pearson for kNN/OT", "source": "artifacts/results/ablation/*/*/metrics_unseen_ctrl.csv plus PBMC metrics.csv", "notebook": "notebooks/Fig3_Ablation.ipynb"},
